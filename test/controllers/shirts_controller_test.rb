...
class ShirtsControllerTest < ActionController::TestCase
  ...
  test "should create shirt" do
    assert_difference('Shirt.count') do
      post :create, shirt: { description: @shirt.description, image: @shirt.image, primary_color: @shirt.primary_color }
    end
  ...
  test "should update shirt" do
    patch :update, id: @shirt, shirt: { description: @shirt.description, image: @shirt.image, primary_color: @shirt.primary_color }
    assert_redirected_to shirt_path(assigns(:shirt))
  end
